...
const About = () => {
  ...
  return (
    <section id="sobre" className="section bg-background py-16 xl:py-24 2xl:py-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-16 2xl:px-24 max-w-7xl 2xl:max-w-[1600px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 xl:gap-8 2xl:gap-12 mb-16 xl:mb-24">
          {features.map((feature, index) => (
            <div key={index} className="text-center p-6 xl:p-8 2xl:p-10 rounded-lg border bg-card hover:shadow-lg transition-shadow duration-200">
