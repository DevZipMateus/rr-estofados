            ...
            >
              <CarouselContent className="-ml-2 md:-ml-4">
                {productImages.map((image, index) => <CarouselItem key={index} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/3 xl:basis-1/4">
                    <div className="p-1">
                      <div 
                        className="aspect-square overflow-hidden rounded-lg shadow-lg border bg-card cursor-pointer"
          ...
          {selectedImageIndex !== null && (
            <div className="relative">
              ...
              <img
                ...
                alt={`Produto ${selectedImageIndex + 1}`}
                className="w-full h-auto max-h-[90vh] object-contain"
              />
              
              <div className="absolute bottom-4 left-1/2 -translate-x-1/2 text-white text-sm bg-black/50 px-3 py-1 rounded">
                {selectedImageIndex + 1} de {productImages.length}
              </div>
            </div>
          )}
        </DialogContent>
