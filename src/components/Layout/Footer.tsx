    ...
    <footer className="bg-black text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Lençóis Paulista Unit */}
          <div>
            <h4 className="text-xl font-semibold mb-6 text-orange-500">Lençóis Paulista</h4>
            <ul className="space-y-3 text-sm">
              <li className="flex items-start">
                <MapPin className="mr-2 mt-1 flex-shrink-0 text-orange-500" size={16} />
          ...
          {/* Botucatu Unit */}
          <div>
            <h4 className="text-xl font-semibold mb-6 text-orange-500">Botucatu</h4>
            <ul className="space-y-3 text-sm">
              <li className="flex items-start">
                <MapPin className="mr-2 mt-1 flex-shrink-0 text-orange-500" size={16} />
